      ...
      <div style={{ flex:1, minHeight:0, position:"relative" }}>
        ...
        {screen === "drawing" && (
          <div style={{
            ...
            <div style={{ textAlign:"center" }}>
              <div style={{ fontSize:18, marginBottom:8, animation:"pulse 1.2s ease-in-out infinite" }}>📊</div>
              <div style={{ fontSize:13, fontFamily:"monospace", color:"rgba(255,255,255,0.45)", letterSpacing:"0.08em" }}>
                Reading chart...
              </div>
            </div>
          </div>
