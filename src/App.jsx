...
function DeveloperSupport({ onClose, onSupport }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 180 }}>
          <div style={{ fontSize: 20, fontWeight: 400, color: '#fff', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
             SUPP THE DEV 
          </div>
          <button
            onClick={onClose}
